...
// Allow HH:MM 24-hour without seconds
...
export const Window = {
  ...
  properties: {
    ...
    window_start:    { type: 'string', pattern: timePattern, description: 'HH:MM, 24-hour' },
    window_end:      { type: 'string', pattern: timePattern, description: 'HH:MM, 24-hour' },
